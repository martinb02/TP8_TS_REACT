...
export const FormProduct :FC<IPropsFromProducts> = ({handleAddProducts}) => {
  ...
  return (
    <Form className="p-4 border rounded m-3">
        ...
        <div className="d-flex justify-content-center mt-4">
            <Button onClick={handleSumbmitFomr} variant="primary">Enviar Producto</Button>
        </div>
    </Form>
